package com.example.springfirstproject.common.config.anotaciones.submodule;
...
public class RequiereSubmoduleAspect {
    ...
    @Around("@annotation(com.example.proyectonico.config.Anotaciones.Submodule.RequiereSubmodule) "
