package com.example.springfirstproject.common.config.annotation.module;
...
public class RequieremoduleAspect {
    ...
    @Around("@annotation(com.example.springfirstproject.common.config.annotation.module.Requieremodule) "
          + "|| @within(com.example.springfirstproject.config.annotation.module.Requieremodule)")
